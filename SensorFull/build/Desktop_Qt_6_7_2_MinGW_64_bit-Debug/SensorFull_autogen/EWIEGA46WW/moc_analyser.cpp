...
constexpr auto qt_meta_stringdata_CLASSAnalyserENDCLASS = QtMocHelpers::stringData(
    "Analyser",
    "onList",
    "",
    "QList<int>",
...
void Analyser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onList((*reinterpret_cast< std::add_pointer_t<QList<int>>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QList<int>>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QList<qlonglong>>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<QList<qlonglong>>>(_a[4])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[5]))); break;
        case 1: _t->getData((*reinterpret_cast< std::add_pointer_t<QMap<QString,QList<int>>>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Analyser::*)(QVector<int> , QVector<int> , QVector<long long> , QVector<long long> , int );
            if (_t _q_method = &Analyser::onList; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Analyser::onList(QVector<int> _t1, QVector<int> _t2, QVector<long long> _t3, QVector<long long> _t4, int _t5)
{
